...
def data_augmentation_batch(data_batch, label_batch, opt):
  ...
  noise_transforms = {
    tio.transforms.RandomNoise(std=45): 0.5,
    tio.transforms.RandomMotion(num_transforms=8): 0.5,
    tio.transforms.RandomBlur(std=2.75): 0.5,
    tio.transforms.RandomGamma(log_gamma=(-0.3, 0.3)): 0.5,
  }
