...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--k_fold', type=int, default=8, required=False, choices = [5,8], help='Select either simple 5-fold or 8-fold crosss validation. ')
        parser.add_argument('--fold', type=int, default=0, required=False, choices = [0,1,2,3,4,5,6,7], help='Select the fold index for k-fold crosss validation. ')
        ...
        parser.add_argument('--optimizer', type=str, default='adam', required=False, help='Choose optimizer {adam, adamax, sgd}.')
